...
app.get('/login', function(req, res) {
    ...
    var scope = 'user-library-modify user-library-read user-read-private user-read-email user-read-playback-state';
...
app.get('api/v1/convertVkToSpotifyLibrary', (req, res) => {
    res.status(200).send({
        success: 'true',
        total: 3,
    });
